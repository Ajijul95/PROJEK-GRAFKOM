...
"""
    ...
    def mulai_animasi(self):
        # Jika animasi sedang pause, tombol Start akan melanjutkan dari posisi terakhir.
    ...
    def pause_animasi(self):
        # Pause hanya menghentikan timer animasi, tidak menghapus rute dan posisi mobil.
    ...
    def _buat_rute_membulat(self, rute):
        ...
        for i in range(1, len(rute) - 1):
            ...
            radius = min(42, len1 * 0.45, len2 * 0.45)
